            ...
            <div className="mb-4.5 flex flex-col gap-6 xl:flex-row">
              <div className="w-full xl:w-1/2">
                ...
                <input
                  ...
                  className="w-full mb-2 rounded border-[1.5px] border-stroke bg-transparent 
                ...
                {errors.productName && <span className='bg-danger text-white px-4 py-1 rounded-xl' 
                >Product name field is required!</span>}
              </div>
            ...
            <div className="mb-4.5">
              ...
              <div className="relative z-20 bg-transparent ">
                <select
                  ...
                  className="relative z-20 w-full appearance-none rounded border border-stroke bg-transparent mb-2 py-3 px-5 
