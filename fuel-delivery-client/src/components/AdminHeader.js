    ...
    return (
        <header className="sticky top-0 z-999 flex w-full bg-white drop-shadow-1">
          ...
          >
            ...
            <div className="flex justify-center pr-6 py-3 items-center gap-2 bg-white drop-shadow-1"> 
            <Link className="bg-success rounded-lg text-white px-2 py-1" to={'/'}>Home page</Link>
          <button className="bg-danger rounded-lg text-white px-2 py-1" type="button" onClick={onLogoutClick}>Logout</button>
        </div>
        </header>
    )
}